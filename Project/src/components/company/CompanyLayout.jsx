...
import { HiHome, HiDocumentAdd, HiUsers, HiCalendar, HiUser, HiLogout, HiMenu, HiX, HiBell } from 'react-icons/hi';
...
const navItems = [
    ...
    { path: '/company/interviews', icon: HiCalendar, label: 'Interviews' },
    { path: '/company/profile', icon: HiUser, label: 'Profile' },
];
